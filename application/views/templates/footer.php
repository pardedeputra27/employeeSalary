...
<footer class="footer footer-static footer-light navbar-border navbar-shadow d-print-none">
	<div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block"><?= date('Y')?> &copy; Tempalate <a class="text-bold-800 grey darken-2" href="https://digtive.github.io/wikidevia/" target="_blank">Digtive</a> | Developer by <a href="https://github.com/pardedeputra27"  target="_blank">Putra</a></span>
...
<script src="<?= base_url() ?>assets/js/core/employeeSalary.js" type="text/javascript"></script>
<!-- END: Page JS-->
