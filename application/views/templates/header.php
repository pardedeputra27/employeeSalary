...
<head>
	...
	<meta name="description" content="Sistem Informasi Penggajian Putra">
	<meta name="keywords" content="Sistem Informasi Penggajian Putra">
	<meta name="author" content="Jihad">
	<title><?= $title ?> -Putra</title>
	...
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
					...
					<h3 class="brand-text">Putra</h3></a></li>
